...
export type TaskRunStatus = "running" | "waiting_approval" | "waiting_input" | "completed" | "failed" | "cancelled";
export type TaskWorkflowState = "PENDING" | "RUNNING" | "WAITING_APPROVAL" | "WAITING_INPUT" | "COMPLETED" | "FAILED" | "CANCELLED";
export type ApprovalStatus = "pending" | "approved" | "rejected" | "answered";
export type ApprovalType = "approval" | "input";
export type RuntimeEventType = "session" | "user" | "assistant" | "tool" | "tool_result" | "heartbeat";
